...
def get_odd(graph):
    ...
    print('Вершини з непарною к-стю ребер:',odds)
    return odds
...
def Chinese_Postman(graph):
    ...
    print('Найкоротші маршути які не включають ребер один одного:', min_sums)
    chinese_dis = added_dis + sum_edges(graph)
    return chinese_dis

print('Найкоротший шлях:', Chinese_Postman(graph))